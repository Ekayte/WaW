...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center"style="max-width:2000px;margin-top:55px">
  ...
  <img src="\WaW\image\badge_guerrier.png" class="imClasse">
...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
	...
	?>
    <h1 class="w3-jumbo">Guerrier</h1>
    <img src="\WaW\image\guerrier.jpg" alt="guerrier" class="w3-image" width="992" height="1108">
  </header>
  ...
  <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
    ...
    <p>	
		<?php
			...
			$sql='SELECT cl_desc FROM Classe WHERE cl_code=4';
			$req = $bdd->prepare($sql);
			$reponse=$req->execute();
    ...
    <p>	
		<?php
				...
				//récuperer les noms des clients de la BDD
				$sql='SELECT cl_effet FROM Classe WHERE cl_code=4';
				$req = $bdd->prepare($sql);
				$reponse=$req->execute();
