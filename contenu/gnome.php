...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center w3-white" style="max-width:2000px;margin-top:55px">
  ...
  <img src="\WaW\image\gnome.jpg" class="imClasse">
...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-white" id="home">
    ...
    <h1 class="w3-jumbo">Gnome</h1>
    <img src="\WaW\image\imgnome.jpg" alt="troll" class="w3-image" width="992" height="1108">
  </header>
  ...
  <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
    ...
    <p>	
		<?php
			...
			$sql='SELECT race_desc FROM Race WHERE race_code=5';
			$req = $bdd->prepare($sql);
			$reponse=$req->execute();
    ...
    <p>	
		<?php
				...
				//récuperer les noms des clients de la BDD
				$sql='SELECT race_effet FROM Race WHERE race_code=5';
				$req = $bdd->prepare($sql);
				$reponse=$req->execute();
