...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center" style="max-width:2000px;margin-top:55px">
  ...
  <img src="\WaW\image\badge_paladin.png" class="imClasse">
...
<div class="w3-padding-large" id="main">
  ...
  <?php 
   ...
   <h1 class="w3-jumbo">Paladin</h1>
    <img src="\WaW\image\paladin.jpg" alt="paladin" class="w3-image" width="992" height="1108">  
  ...
  <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
    ...
    <p>	
		<?php
			...
			$sql='SELECT cl_desc FROM Classe WHERE cl_code=1';
			$req = $bdd->prepare($sql);
			$reponse=$req->execute();
    ...
    <p>	
		<?php
				...
				//récuperer les noms des clients de la BDD
				$sql='SELECT cl_effet FROM Classe WHERE cl_code=1';
				$req = $bdd->prepare($sql);
				$reponse=$req->execute();
