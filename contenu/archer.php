...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center"style="max-width:2000px;margin-top:55px">
  <!-- image Avatar -->
  <img src="\WaW\image\badge_archer.png" class="imClasse">
  ...
  <a href="mage.php" class="w3-bar-item w3-button w3-padding-large w3-hover-black">
    ...
    <a href="moine.php" class="w3-bar-item w3-button w3-padding-large w3-hover-black">
...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
	...
	?>
    <h1 class="w3-jumbo">Archer</h1>
    <img src="\WaW\image\archer.jpg" alt="archer" class="w3-image" width="992" height="1108">
  </header>
...
<!----------------------------------------------------------------------------------->
<!--						requete SQL pour afficher effet et description		   -->
<!----------------------------------------------------------------------------------->
		<?php
			$user='root';
			$pass='root';
			...
			$sql='SELECT cl_desc FROM Classe WHERE cl_code=3';
			$req = $bdd->prepare($sql);
			$reponse=$req->execute();
    ...
    <p>	
		<?php
				...
				//récuperer les noms des clients de la BDD
				$sql='SELECT cl_effet FROM Classe WHERE cl_code=3';
				$req = $bdd->prepare($sql);
				$reponse=$req->execute();
